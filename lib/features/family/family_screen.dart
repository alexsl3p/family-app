...
class FamilyScreen extends StatelessWidget {
  ...
  static const _members = [
    _Member(name: 'Мама', role: 'Создатель', status: 'Дома', color: AppColors.pink, isCreator: true),
    _Member(name: 'Папа', role: 'Участник', status: 'На работе', color: AppColors.blue, isCreator: false),
    _Member(name: 'Лёня', role: 'Участник', status: 'В школе', color: AppColors.green, isCreator: false),
  ];
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: Text('Семья', style: AppTextStyles.h1)),
          Container(
            width: 34,
            height: 34,
    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Поделитесь кодом, чтобы пригласить в семью',
